...
class ListaReporte:
    ...
    def insertar(self, Cancion, Artistas, Album, Genero, Anio):
        nuevo = NodoReporte(Cancion, Artistas, Album, Genero, Anio)
    ...
    def obtener(self):
        ...
        if ListaReporte.correlativo < self.size:
            ...
            return aux
            print ListaReporte.correlativo
        return NodoReporte("None", "None", "None", "None", "None")
