        ...
        for usuarios in coleccionUsuarios:
            ...
            for usuario in coleccionUsuario:
                self.usuarios.InsertarFinal(usuario.find(
                    'nombre').text, usuario.find('pass').text)
                        ...
                        for canciones in coleccionCanciones:
                            ...
                            for cancion in coleccionCancion:
                                ...
                                self.listaReporte.insertar(
                                    can, nombreArtista, nombreAlbum, gen, anio)
                        abbAlbumes.insertar(nombreAlbum, listaCanciones)
                self.matriz.insertarArtista(
                    anio, gen, nombreArtista, abbAlbumes)
        self.listaReporte.insertar("None", "None", "None", "None", "None")
