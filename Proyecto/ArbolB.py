...
class ArbolB(object):
    ...
    def insertar(self, nombre, albumes):
        nodo = Artista(nombre, albumes)
        if self.estaVacio():
            self.raiz = Rama()
        ...
        while nodo != None:
            if nombre.lower() < nodo.getNombre().lower():
                if rama.esHoja():
                    ...
                    return busca(nombre, nodo.getIzquierda())
                ...
                if rama.esHoja():
                    ...
                    return busca(nombre, nodo.getDerecha())
